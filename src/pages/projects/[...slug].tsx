...
export default function SingleBlogPage({
  ...
  const COMMIT_HISTORY_LINK = `https://github.com/AlchemistJacks/alchemistjacks/commits/main/src/contents/projects/${frontmatter.slug}.mdx`;
        ...
        <section className=''>
          <div className='layout'>
            ...
            {populatedRecommendations.length > 0 && (
              <div className='mt-20'>
                <h2>
                  <Accent>Other projects you might like</Accent>
                </h2>
            ...
            <CustomLink href='/projects' className='mt-8 inline-block'>
              ← Back to projects
            </CustomLink>
          </div>
        </section>
