...
For `.layout` class explanation, check out my project write-up about [Tailwind CSS Best Practice](https://alchemistjacks.com/projects/tailwindcss-best-practice)
