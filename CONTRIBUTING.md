...
If you come across a bug or something that can be improved, please [open an issue](https://github.com/AlchemistJacks/alchemistjacks/issues). It would be helpful if you provide some description or screen recording!
...
Major features are feature flagged in [constants/env.ts](https://github.com/AlchemistJacks/alchemistjacks/blob/main/src/constants/env.ts)
